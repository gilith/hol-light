...
let adder2_syn = [("adder2",adder2_def)];;

let adder3_syn =
    setify (("adder3",adder3_def) :: xor3_syn @ majority3_syn);;

let badder2_syn = [("badder2",badder2_def)];;

let badder3_syn =
    setify (("badder3",badder3_def) :: bxor3_syn @ bmajority3_syn);;

let sum_carry_bit_syn =
    setify (("sum_carry_bit",sum_carry_bit_def) :: badder2_syn);;
